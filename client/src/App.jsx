...
export default function App() {
  ...
  useEffect(() => {
    ...
    eventSource.onerror = (err) => {
      ...
      // Let the browser handle auto-reconnect
    };
  ...
  useEffect(() => {
    fetchData();
    // Poll data tables every 15 seconds to keep dashboard state fresh
    ...
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          ...
          <p style={{ marginTop: '4px', fontSize: '10px' }}>Running in Local Mode</p>
        </div>
      </aside>
